  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden items-center justify-center"
        style={{ background: "linear-gradient(135deg, #09090b 0%, #111113 40%, #1a1033 100%)" }}>
        ...
        <div className="relative z-10 max-w-lg px-12">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-semibold text-text-primary tracking-tight leading-tight mb-3">
              DevFlow Forge
            </h1>
      ...
      <div className="flex-1 flex items-center justify-center px-6 bg-surface">
        ...
        >
          <div className="lg:hidden mb-10">
            <div className="w-10 h-10 rounded-lg bg-accent/15 flex items-center justify-center mb-4 border border-accent/20">
              <svg className="w-5 h-5 text-accent-light" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
              </svg>
            </div>
            <h1 className="text-2xl font-semibold text-text-primary tracking-tight">DevFlow Forge</h1>
          </div>

          <h2 className="text-xl font-semibold text-text-primary mb-1">登录</h2>
          <p className="text-sm text-text-tertiary mb-8">使用 GitHub 账号登录以开始使用</p>

          <button
            onClick={handleLogin}
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-text-primary text-surface font-medium py-3 px-4 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 cursor-pointer"
          >
            {loading ? (
